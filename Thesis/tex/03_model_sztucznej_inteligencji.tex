...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/03_model_ai/Example_Prediction.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/03_model_ai/U-NET.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/03_model_ai/mlflow_versions.png}
