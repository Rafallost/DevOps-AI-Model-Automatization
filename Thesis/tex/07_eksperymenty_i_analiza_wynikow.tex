...
\hline
Przygotowanie danych & % [UZUPEŁNIĆ: min] & % [UZUPEŁNIĆ: min] & $<1$ min \\
Walidacja danych & % [UZUPEŁNIĆ: min] & % [UZUPEŁNIĆ: min] & % [UZUPEŁNIĆ: min] \\
Trening modelu & % [UZUPEŁNIĆ: min] & % [UZUPEŁNIĆ: min] & % [UZUPEŁNIĆ: min] \\
Ocena jakości & % [UZUPEŁNIĆ: min] & % [UZUPEŁNIĆ: min] & $<1$ min \\
Wdrożenie & % [UZUPEŁNIĆ: min] & % [UZUPEŁNIĆ: min] & % [UZUPEŁNIĆ: min] \\
\hline
\textbf{Łącznie} & % [UZUPEŁNIĆ: min] & % [UZUPEŁNIĆ: min] & % [UZUPEŁNIĆ: min] \\
\hline
\end{tabular}
\end{table}
...
v1 --- pierwsze trenowanie & % [UZUPEŁNIĆ] & % [UZUPEŁNIĆ] & % [UZUPEŁNIĆ] \\
v2 --- po dodaniu danych & % [UZUPEŁNIĆ] & % [UZUPEŁNIĆ] & % [UZUPEŁNIĆ] \\
\hline
\end{tabular}
\end{table}
...
\hline
EC2 t3.large (trening) & % [UZUPEŁNIĆ] USD/h & Uruchamiana tylko podczas treningu \\
EC2 t3.large (serwowanie) & % [UZUPEŁNIĆ] USD/h & Stop/start przez workflow \\
S3 (artefakty) & % [UZUPEŁNIĆ] USD/mies. & Zależy od liczby modeli \\
ECR (obrazy) & % [UZUPEŁNIĆ] USD/mies. & \\
\hline
\textbf{Łącznie (projekt)} & % [UZUPEŁNIĆ] USD & Za cały okres realizacji \\
\hline
\end{tabular}
\end{table}
