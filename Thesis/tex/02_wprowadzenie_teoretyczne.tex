...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.65\linewidth]{img/02_wprowadzenie_teoretyczne/CI-CD.jpg}
...
\begin{itemize}
  ...
  \item \textbf{Hook} --- skrypt wywoływany automatycznie przez zdarzenie Git (np. \texttt{pre-push}).
\end{itemize}
...
Kluczową cechą GitHub Actions jest możliwość użycia \textbf{self-hosted runners}. Maszyny zarządzane przez użytkownika, co w niniejszym projekcie pozwala uruchamiać trening bezpośrednio na instancji EC2 wyposażonej w odpowiedni sprzęt obliczeniowy, bez potrzeby przekazywania danych treningowych przez sieć do zewnętrznego runnera.
