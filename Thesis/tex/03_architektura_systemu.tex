...
\begin{figure}[H]
\centering
\IfFileExists{img/03_architektura_systemu/architecture-overview.png}{%
  \includegraphics[width=\textwidth]{img/03_architektura_systemu/architecture-overview.png}%
}{%
  \fbox{\parbox{0.9\textwidth}{\centering\vspace{1cm}\textit{[Do uzupełnienia: diagram C4 architecture-overview.png]}\vspace{1cm}}}%
}
...
\begin{figure}[H]
\centering
\IfFileExists{img/03_architektura_systemu/data-flow.png}{%
  \includegraphics[scale=0.09]{img/03_architektura_systemu/data-flow.png}%
}{%
  \fbox{\parbox{0.9\textwidth}{\centering\vspace{1cm}\textit{[Do uzupełnienia: diagram przepływu danych data-flow.png]}\vspace{1cm}}}%
}
