...
Bramka jakości jest mechanizmem decydującym, czy nowy model jest wystarczająco dobry, żeby trafić do produkcji. Implementacja jest w skrypcie \texttt{quality-gate.py} i korzysta z API MLflow Model Registry \cite{mlflow_model_registry}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{img/05_pipline_ci_cd/not_improved_model_example.png}
