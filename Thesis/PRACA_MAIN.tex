...
\include{tex/01_wstep}
\include{tex/02_wprowadzenie_teoretyczne}
\include{tex/03_architektura_systemu}
\include{tex/04_model_sztucznej_inteligencji}
\include{tex/05_pipeline_ci_cd}
\include{tex/06_wdrozenie_systemu}
\include{tex/07_analiza_wynikow_i_dzialania_systemu}
